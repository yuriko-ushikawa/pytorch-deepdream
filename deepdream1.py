...
if __name__ == "__main__":
    ...
    #Override params with the ones defined in the code below
    parser.add_argument("--code_args", action="store_true", help="Overrides parameters with the ones edited via code below.", default=False)
    # Common params
    ...
    parser.add_argument("--model_name", choices=[m.name for m in SupportedModels],
                        ...
                        default=SupportedModels.VGG16.name)
                  #     default=SupportedModels.GOOGLENET.name)
                  #      default=SupportedModels.VGG16_EXPERIMENTAL.name)
                   #     default=SupportedModels.RESNET50.name)
                  #      default=SupportedModels.ALEXNET.name)
                    #    default=SupportedModels.InceptionV1.name)
                   #      default=SupportedModels.SqueezNet_1.name)
                   # default=SupportedModels.SqueezNet_1.name)
